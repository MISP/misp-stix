...
class TestInternalSTIX20Import(TestInternalSTIX2Import, TestSTIX20, TestSTIX20Import):
    ...
    def test_stix20_classification_auto_detection_warns_and_explicit_is_silent(self):
        ...
        with TemporaryDirectory() as tmp_dir:
            filename = Path(tmp_dir) / 'internal.stix20.json'
    ...
    def test_stix20_classification_forced_external_warns_on_mismatch(self):
        from misp_stix_converter import stix_2_to_misp
        from pathlib import Path
        from tempfile import TemporaryDirectory
        bundle = TestInternalSTIX20Bundles.get_bundle_with_domain_indicator_attribute()
    ...
    def test_stix20_no_template_folds_two_relations_to_one_name(self):
        self._check_no_template_folds_two_relations_to_one_name()

    def test_stix20_static_custom_property_entries_agree_with_the_template(self):
    ...
    def test_stix20_bundle_with_domain_ip_observable_objects(self):
        ...
        pattern = self._get_compiled_pattern(ind2)
    ...
    def test_stix20_object_relations_restored_from_the_template(self):
        ...
        from misp_stix_converter import MISPtoSTIX20Parser
        from .test_events import (
            get_event_with_email_object, get_event_with_employee_object,
            get_event_with_ip_port_object, get_event_with_person_object)
        ptr_record = {
        ...
        self.assertIn(
            ...
            self._round_trip_object_attributes(MISPtoSTIX20Parser(), employee)
        )
