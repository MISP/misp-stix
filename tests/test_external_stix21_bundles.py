...
_EMAIL_ADDRESS_ATTRIBUTES = [
    ...
    },
    {
        ...
        "pattern": "[email-addr:value = 'donald.duck@disney.com' AND email-addr:display_name = 'Donald Duck']",
        "pattern_type": "stix",
        "pattern_version": "2.1",
        "valid_from": "2024-10-25T16:22:00Z"
    }
...
_IP_ADDRESS_ATTRIBUTES = [
    ...
    },
    {
        ...
        "pattern": "[ipv4-addr:value = '185.194.93.14']",
        "pattern_type": "stix",
        "pattern_version": "2.1",
        "valid_from": "2024-10-25T16:22:00Z"
    }
...
_MUTEX_ATTRIBUTES = [
    ...
    },
    {
        ...
        "pattern": "[mutex:name = 'sensitive_resource_lock']",
        "pattern_type": "stix",
        "pattern_version": "2.1",
        "valid_from": "2024-10-25T16:22:00Z"
    }
...
_NETWORK_TRAFFIC_OBJECTS = [
    ...
    },
    {
        ...
        "pattern": "[network-traffic:dst_port = 24678 AND network-traffic:protocols[*] = 'http']",
        "pattern_type": "stix",
        "pattern_version": "2.1",
        "valid_from": "2024-10-25T16:22:00Z"
    }
...
_URL_ATTRIBUTES = [
    ...
    },
    {
        ...
        "last_observed": "2020-10-25T16:22:00Z",
        "number_observed": 1,
        "object_refs": ["url--f93cb275-0366-4ecc-abf0-a17928d1e177"]
    },
    {
        "type": "url",
        "spec_version": "2.1",
...
_REGISTRY_KEY_INDICATORS = [
    ...
    },
    {
        ...
        "pattern": "[windows-registry-key:key = 'hkey_local_machine\\\\system\\\\bar\\\\foo' AND windows-registry-key:modified_time = '2029-10-25T16:22:00Z' AND windows-registry-key:number_of_subkeys = 2 AND windows-registry-key:values[0].name = 'Foo' AND windows-registry-key:values[0].data = 'qwerty' AND windows-registry-key:values[1].name = 'Bar' AND windows-registry-key:values[1].data = '42']",
        "pattern_type": "stix",
        "pattern_version": "2.1",
        "valid_from": "2024-10-25T16:22:00Z"
    }
