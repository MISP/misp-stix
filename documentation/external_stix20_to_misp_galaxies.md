        ...
        "GalaxyCluster": [
            {
                ...
                "source": "MISP-Project",
                "version": "20",
                "collection_uuid": "2d018cbb-4236-53c8-aeba-0aa1b51e636e",
...
- campaign
  ...
  - MISP
    ```json
    {
        "GalaxyCluster": [
            {
                ...
                "source": "MISP-Project",
                "version": "20",
                "collection_uuid": "93edca62-86ed-5c91-b7a1-924cbe767db4",
        ...
        "namespace": "stix",
        "distribution": "0",
        "uuid": "93edca62-86ed-5c91-b7a1-924cbe767db4",
        "version": "20",
        "icon": "user-secret",
        "type": "stix-2.0-campaign",
...
- course-of-action
  ...
  - MISP
    ```json
    {
        "GalaxyCluster": [
            {
                ...
                "source": "MISP-Project",
                "version": "20",
                "collection_uuid": "517debfb-57bd-5553-8409-4f4f87cabec9",
        ...
        "namespace": "stix",
        "distribution": "0",
        "uuid": "517debfb-57bd-5553-8409-4f4f87cabec9",
        "version": "20",
        "icon": "link",
        "type": "stix-2.0-course-of-action",
...
- intrusion-set
  ...
  - MISP
    ```json
    {
        "GalaxyCluster": [
            {
                ...
                "source": "MISP-Project",
                "version": "20",
                "collection_uuid": "cee0019c-b23c-54a1-a9ef-343fe27ce4e8",
        ...
        "namespace": "stix",
        "distribution": "0",
        "uuid": "cee0019c-b23c-54a1-a9ef-343fe27ce4e8",
        "version": "20",
        "icon": "user-secret",
        "type": "stix-2.0-intrusion-set",
...
- malware
  ...
  - MISP
    ```json
    {
        "GalaxyCluster": [
            {
                ...
                "source": "MISP-Project",
                "version": "20",
                "collection_uuid": "17676fb9-d799-5a6e-9acb-e7c27b00c2a4",
        ...
        "namespace": "stix",
        "distribution": "0",
        "uuid": "17676fb9-d799-5a6e-9acb-e7c27b00c2a4",
        "version": "20",
        "icon": "optin-monster",
        "type": "stix-2.0-malware",
...
- threat-actor
  ...
  - MISP
    ```json
    {
        "GalaxyCluster": [
            {
                ...
                "source": "MISP-Project",
                "version": "20",
                "collection_uuid": "5c3ddbe1-8c31-5599-a89d-2d3a6a56cbd7",
        ...
        "namespace": "stix",
        "distribution": "0",
        "uuid": "5c3ddbe1-8c31-5599-a89d-2d3a6a56cbd7",
        "version": "20",
        "icon": "user-secret",
        "type": "stix-2.0-threat-actor",
...
- tool
  ...
  - MISP
    ```json
    {
        "GalaxyCluster": [
            {
                ...
                "source": "MISP-Project",
                "version": "20",
                "collection_uuid": "e4044312-16ad-5796-8db5-a9a17959180c",
                "type": "stix-2.0-tool",
                "description": "This program extracts cached password hashes from a system\u2019s registry."
            }
        ],
        ...
        "namespace": "stix",
        "distribution": "0",
        "uuid": "e4044312-16ad-5796-8db5-a9a17959180c",
        "version": "20",
        "icon": "gavel",
        "type": "stix-2.0-tool",
        "name": "STIX 2.0 Tool"
...
- vulnerability
  ...
  - MISP
    ```json
    {
        "GalaxyCluster": [
            {
                ...
                "source": "MISP-Project",
                "version": "20",
                "collection_uuid": "9130fa43-2d0a-55a0-92ef-08d066ec4460",
        ...
        "namespace": "stix",
        "distribution": "0",
        "uuid": "9130fa43-2d0a-55a0-92ef-08d066ec4460",
        "version": "20",
        "icon": "bug",
        "type": "stix-2.0-vulnerability",
