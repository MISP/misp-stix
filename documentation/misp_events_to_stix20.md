...
Embedded galaxies also trigger some specific computation in order to build the corresponding references between the different STIX 2.0 objects.  
- With galaxies embedded in attributes, the result is STIX objects directly linked together with a `Relationship` object which describes the link between the object generated from an attribute and the object generated from a galaxy:
  ...
  - STIX
    ...
    {
        "type": "bundle",
        "id": "bundle--48f1a93b-7287-4f21-94b2-29cacaf09cf4",
        "spec_version": "2.0",
        "objects": [
            {
                "type": "identity",
            ...
            },
            {
                ...
                "object_refs": [
                    ...
                    "relationship--7e168e72-15e1-4393-b370-602911f9bcfd",
                    "relationship--c099b5fa-719c-46a7-9a02-51a6074d22fe"
                ],
                "labels": [
                    "Threat-Report",
                    "misp:tool=\"MISP-STIX-Converter\""
            ...
            {
                "type": "relationship",
                "id": "relationship--7e168e72-15e1-4393-b370-602911f9bcfd",
                "created": "2020-10-25T16:22:00.000Z",
                "modified": "2020-10-25T16:22:00.000Z",
            ...
            {
                "type": "relationship",
                "id": "relationship--c099b5fa-719c-46a7-9a02-51a6074d22fe",
                "created": "2020-10-25T16:22:00.000Z",
                "modified": "2020-10-25T16:22:00.000Z",
...
- Galaxies can also be embedded in objects attributes, in which case the complete MISP object is exported in a single STIX object. The embedded galaxies are then extracted, exported as STIX objects, and all linked to the same STIX object (the one generated from the MISP object export):
    ...
    {
        "type": "bundle",
        "id": "bundle--abae1ef4-f295-4b76-a671-46284c28e0f6",
        "spec_version": "2.0",
        "objects": [
            {
                "type": "identity",
            ...
            },
            {
                ...
                "object_refs": [
                    ...
                    "relationship--8e40e718-8ca3-48cf-93d2-722e9d4823a5",
                    "relationship--af715d6e-6735-430b-960d-4f82fd9632a7",
                    "relationship--7e732309-cfc1-451f-961e-d3ba6e738622",
                    "relationship--a5b53264-1837-4cee-b94c-e6f19201f158"
                ],
                "labels": [
                    "Threat-Report",
                    "misp:tool=\"MISP-STIX-Converter\""
            ...
            {
                "type": "relationship",
                "id": "relationship--8e40e718-8ca3-48cf-93d2-722e9d4823a5",
                "created": "2020-10-25T16:22:00.000Z",
                "modified": "2020-10-25T16:22:00.000Z",
            ...
            {
                "type": "relationship",
                "id": "relationship--af715d6e-6735-430b-960d-4f82fd9632a7",
                "created": "2020-10-25T16:22:00.000Z",
                "modified": "2020-10-25T16:22:00.000Z",
                "relationship_type": "has",
                "source_ref": "course-of-action--5d514ff9-ac30-4fb5-b9e7-3eb4a964451a",
            ...
            {
                "type": "relationship",
                "id": "relationship--7e732309-cfc1-451f-961e-d3ba6e738622",
                "created": "2020-10-25T16:22:00.000Z",
                "modified": "2020-10-25T16:22:00.000Z",
                "relationship_type": "has",
            ...
            {
                "type": "relationship",
                "id": "relationship--a5b53264-1837-4cee-b94c-e6f19201f158",
                "created": "2020-10-25T16:22:00.000Z",
                "modified": "2020-10-25T16:22:00.000Z",
                "relationship_type": "has",
                "source_ref": "vulnerability--5e579975-e9cc-46c6-a6ad-1611a964451a",
...
- With the last examples we saw relationships describing the logical relation that links two STIX objects when they were initially embedded one in the other. Now the use case is a MISP object with a reference to another MISP object:
  ...
  - STIX
    ...
    {
        "type": "bundle",
        "id": "bundle--6359d5a8-10a6-474c-af95-fd3c4f4b89bb",
        "spec_version": "2.0",
        "objects": [
            {
                "type": "identity",
            ...
            },
            {
                ...
                "object_refs": [
                    ...
                    "relationship--9b9fd554-d21a-4ae4-a26f-4d1fff3c782c",
                    "relationship--9359cdc5-a2cb-4082-be24-611a1eb07e8b"
                ],
                "labels": [
                    "Threat-Report",
                    "misp:tool=\"MISP-STIX-Converter\""
            ...
            {
                "type": "relationship",
                "id": "relationship--9b9fd554-d21a-4ae4-a26f-4d1fff3c782c",
                "created": "2020-10-25T16:22:00.000Z",
                "modified": "2020-10-25T16:22:00.000Z",
                "relationship_type": "includes",
            ...
            {
                "type": "relationship",
                "id": "relationship--9359cdc5-a2cb-4082-be24-611a1eb07e8b",
                "created": "2020-10-25T16:22:00.000Z",
                "modified": "2020-10-25T16:22:00.000Z",
                "relationship_type": "affects",
