# STIX 2.0 to MISP Attributes mapping

When importing STIX 2.0 content into MISP, `Indicator` objects are parsed to produce MISP attributes with the `to_ids` flag set, while `Observed Data` objects produce MISP attributes with the `to_ids` flag unset.
...
- filename|sha3-256
  ...
  - MISP
    ```json
    {
        ...
        "value": "filename12|39725234628358bcce613d1d1c07c2c3d2d106e3a6ac192016b46e5dddcd03f4",
        "category": "Payload delivery",
        "to_ids": true,
        "timestamp": "1603642920",
        "disable_correlation": false,
...
- filename|tlsh
  ...
  - MISP
    ```json
    {
        ...
        "type": "filename|tlsh",
        "value": "filename14|c325af62e2f15cf7c32316389d1b57a46827be703d3879866bf52c385f396813829297",
        "category": "Payload delivery",
        "to_ids": true,
        "timestamp": "1603642920",
        "disable_correlation": false,
...
- filename|vhash
  ...
  - MISP
    ```json
    {
        ...
        "type": "filename|vhash",
        "value": "filename15|115056655d15151138z66hz1021z55z66z3",
        "category": "Payload delivery",
        "to_ids": true,
        "timestamp": "1603642920",
        "disable_correlation": false,
...
- [Objects mapping](stix20_to_misp_objects.md)
