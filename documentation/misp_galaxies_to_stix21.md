...
- STIX 2.0 Attack Pattern
  ...
  - STIX
    ```json
    {
        "type": "attack-pattern",
        "spec_version": "2.1",
        "id": "attack-pattern--ef6eb51e-e601-5d4f-8aad-124c4f5507b0",
        "created": "2020-10-25T16:22:00.000Z",
        "modified": "2020-10-25T16:22:00.000Z",
        ...
        "labels": [
            "misp:galaxy-name=\"STIX 2.0 Attack Pattern\"",
            "misp:galaxy-type=\"stix-2.0-attack-pattern\""
        ],
        "external_references": [
            {
                "source_name": "capec",
...
- STIX 2.0 Campaign
  ...
  - STIX
    ```json
    {
        "type": "campaign",
        "spec_version": "2.1",
        "id": "campaign--0dd0896b-8834-5025-a4d4-c0f4bbf7d403",
        "created": "2020-10-25T16:22:00.000Z",
        "modified": "2020-10-25T16:22:00.000Z",
        "name": "RRN",
        "description": "Active since 2008, this campaign mostly targets the financial services industry, though we have also seen activity in the telecom, government, and defense sectors.",
        ...
        "objective": "manipulation",
        "labels": [
            "misp:galaxy-name=\"STIX 2.0 Campaign\"",
            "misp:galaxy-type=\"stix-2.0-campaign\""
        ]
    }
    ```
...
- STIX 2.0 Course of Action
  - MISP
    ```json
    {
        "GalaxyCluster": [
            {
                ...
                "type": "stix-2.0-course-of-action"
            }
        ],
        ...
        "type": "stix-2.0-course-of-action",
        "name": "STIX 2.0 Course of Action"
    }
    ```
  - STIX
    ```json
    {
        "type": "course-of-action",
        "spec_version": "2.1",
        "id": "course-of-action--58334ddd-728f-575a-a0df-b211ef74f679",
        "created": "2020-10-25T16:22:00.000Z",
        "modified": "2020-10-25T16:22:00.000Z",
        "name": "Exploitation for Client Execution Mitigation",
        "description": "Browser sandboxes can be used to mitigate some of the impact of exploitation, but sandbox escapes may still exist",
        "labels": [
            "misp:galaxy-name=\"STIX 2.0 Course of Action\"",
            "misp:galaxy-type=\"stix-2.0-course-of-action\""
        ],
        "external_references": [
            {
                "source_name": "mitre-attack",
...
- STIX 2.0 Intrusion Set
  ...
  - STIX
    ```json
    {
        "type": "intrusion-set",
        "spec_version": "2.1",
        "id": "intrusion-set--86ddf25a-5c34-52c8-a9c3-07a06f3cc5d3",
        "created": "2020-10-25T16:22:00.000Z",
        "modified": "2020-10-25T16:22:00.000Z",
        "name": "APT1",
        "description": "APT1 is a single organization of operators that has conducted a cyber espionage campaign against a broad range of victims since at least 2006.",
        ...
        "primary_motivation": "organizational-gain",
        "labels": [
            "misp:galaxy-name=\"STIX 2.0 Intrusion Set\"",
            "misp:galaxy-type=\"stix-2.0-intrusion-set\""
        ]
    }
    ```
...
- STIX 2.0 Malware
  ...
  - STIX
    ```json
    {
        "type": "malware",
        "spec_version": "2.1",
        "id": "malware--d7ec91c0-e001-5992-9258-b0147fc71014",
        "created": "2020-10-25T16:22:00.000Z",
        "modified": "2020-10-25T16:22:00.000Z",
        "name": "MANITSME",
        "description": "This malware will beacon out at random intervals to the remote attacker. The attacker can run programs, execute arbitrary commands, and easily upload and download files.",
        ...
        "is_family": false,
        "labels": [
            "misp:galaxy-name=\"STIX 2.0 Malware\"",
            "misp:galaxy-type=\"stix-2.0-malware\""
        ]
    }
    ```
...
- STIX 2.0 Threat Actor
  ...
  - STIX
    ```json
    {
        "type": "threat-actor",
        "spec_version": "2.1",
        "id": "threat-actor--68f82328-1545-54eb-9f75-bfc6967c172c",
        "created": "2020-10-25T16:22:00.000Z",
        "modified": "2020-10-25T16:22:00.000Z",
        "name": "Ugly Gorilla",
        "description": "Ugly gorilla",
        ...
        "primary_motivation": "organizational-gain",
        "labels": [
            "misp:galaxy-name=\"STIX 2.0 Threat Actor\"",
            "misp:galaxy-type=\"stix-2.0-threat-actor\""
        ]
    }
    ```
...
- STIX 2.0 Tool
  ...
  - STIX
    ```json
    {
        "type": "tool",
        "spec_version": "2.1",
        "id": "tool--8ad88bfb-1172-5149-8f15-10ef14fa5868",
        "created": "2020-10-25T16:22:00.000Z",
        "modified": "2020-10-25T16:22:00.000Z",
        "name": "fgdump",
        "description": "Windows password hash dumper",
        ...
        "tool_version": "2.1.0",
        "labels": [
            "misp:galaxy-name=\"STIX 2.0 Tool\"",
            "misp:galaxy-type=\"stix-2.0-tool\""
        ],
        "external_references": [
            {
                "source_name": "url",
...
- STIX 2.0 Vulnerability
  ...
  - STIX
    ```json
    {
        "type": "vulnerability",
        "spec_version": "2.1",
        "id": "vulnerability--548bae32-76f7-5cbe-8154-df9ac92b29f5",
        "created": "2020-10-25T16:22:00.000Z",
        "modified": "2020-10-25T16:22:00.000Z",
        "name": "CVE-2009-4324",
        "description": "Adobe acrobat PDF's used by admin@338",
        "labels": [
            "misp:galaxy-name=\"STIX 2.0 Vulnerability\"",
            "misp:galaxy-type=\"stix-2.0-vulnerability\""
        ],
        "external_references": [
            {
                "source_name": "cve",
...
- STIX 2.1 Attack Pattern
  ...
  - STIX
    ```json
    {
        ...
        "labels": [
            "misp:galaxy-name=\"STIX 2.1 Attack Pattern\"",
            "misp:galaxy-type=\"stix-2.1-attack-pattern\""
        ],
        "external_references": [
            {
                "source_name": "capec",
...
- STIX 2.1 Campaign
  ...
  - STIX
    ```json
    {
        ...
        "objective": "manipulation",
        "labels": [
            "misp:galaxy-name=\"STIX 2.1 Campaign\"",
            "misp:galaxy-type=\"stix-2.1-campaign\""
        ]
    }
    ```
...
- STIX 2.1 Course of Action
  ...
  - STIX
    ```json
    {
        ...
        "description": "Browser sandboxes can be used to mitigate some of the impact of exploitation, but sandbox escapes may still exist",
        "labels": [
            "misp:galaxy-name=\"STIX 2.1 Course of Action\"",
            "misp:galaxy-type=\"stix-2.1-course-of-action\""
        ],
        "external_references": [
            {
                "source_name": "mitre-attack",
...
- STIX 2.1 Intrusion Set
  ...
  - STIX
    ```json
    {
        ...
        "primary_motivation": "organizational-gain",
        "labels": [
            "misp:galaxy-name=\"STIX 2.1 Intrusion Set\"",
            "misp:galaxy-type=\"stix-2.1-intrusion-set\""
        ]
    }
    ```
...
- STIX 2.1 Location
  ...
  - STIX
    ```json
    {
        "type": "location",
        "spec_version": "2.1",
        "id": "location--4a8023c8-fba6-54e8-b81e-37d515a7617c",
        "created": "2020-10-25T16:22:00.000Z",
        "modified": "2020-10-25T16:22:00.000Z",
        ...
        "administrative_area": "US-DC",
        "labels": [
            "misp:galaxy-name=\"STIX 2.1 Location\"",
            "misp:galaxy-type=\"stix-2.1-location\""
        ]
    }
    ```
...
- STIX 2.1 Malware
  ...
  - STIX
    ```json
    {
        ...
        "labels": [
            "misp:galaxy-name=\"STIX 2.1 Malware\"",
            "misp:galaxy-type=\"stix-2.1-malware\""
        ]
    }
    ```
...
- STIX 2.1 Threat Actor
  ...
  - STIX
    ```json
    {
        ...
        "primary_motivation": "organizational-gain",
        "labels": [
            "misp:galaxy-name=\"STIX 2.1 Threat Actor\"",
            "misp:galaxy-type=\"stix-2.1-threat-actor\""
        ]
    }
    ```
...
- STIX 2.1 Tool
  ...
  - STIX
    ```json
    {
        ...
        "tool_version": "2.1.0",
        "labels": [
            "misp:galaxy-name=\"STIX 2.1 Tool\"",
            "misp:galaxy-type=\"stix-2.1-tool\""
        ],
        "external_references": [
            {
                "source_name": "url",
...
- STIX 2.1 Vulnerability
  ...
  - STIX
    ```json
    {
        ...
        "description": "Adobe acrobat PDF's used by admin@338",
        "labels": [
            "misp:galaxy-name=\"STIX 2.1 Vulnerability\"",
            "misp:galaxy-type=\"stix-2.1-vulnerability\""
        ],
        "external_references": [
            {
                "source_name": "cve",
